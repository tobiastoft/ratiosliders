...
RatioSlider.prototype.resetSlider=function(c){for(var c=c.data.that,b=0;b<c.segments.length;b++)c.segments[b].setRatio(),c.segments[b].originalRight=$(c.segments[b].obj).width()+$(c.segments[b].obj).offset().left,c.adjustSegments()};RatioSlider.prototype.addSegment=function(c,b){var a=new RatioSegment(this);a.label=c;a.originalRatio=b;this.segments.push(a)};
RatioSlider.prototype.attachHandles=function(){for(var c=this.segments.length,b=0;b<c;b++)this.segments[b].addHtml(this.elmId),this.segments[b].setRatio(),this.segments[b].maxWidth=$(this.obj).width()-this.segmentMinWidth*(c-1),b<c-1&&(this.segments[b].makeResizable(),$(this.segments[b].obj).bind("resizestart",{that:this},this.startResizing),$(this.segments[b].obj).bind("resizestop",{that:this},this.stopResizing)),b>0&&b<c-1&&$(this.segments[b].obj).addClass("mid");$(this.segments[0].obj).addClass("first");
$(this.segments[c-1].obj).addClass("last")};
...
a.segments.length-1&&(i.offset().left+i.width()+10>$("#"+a.segments[d+1].popupId).offset().left?l++:l=0),f.push(l);f.reverse();for(d=0;d<f.length;d++)$("#"+a.segments[d].popupId+">#content").removeClass(),d>0&&d<a.segments.length-1&&$("#"+a.segments[d].popupId+">#content").addClass("mid"),$("#"+a.segments[d].popupId+">#content").addClass("overlap-"+f[d]);$("#"+a.segments[0].popupId+">#content").addClass("first");$("#"+a.segments[a.segments.length-1].popupId+">#content").addClass("last");a.returnRatios()};
